...
const ReceiveDetails = () => {
  ...
  const [tempCustomUnit, setTempCustomUnit] = useState<DoichainUnit>(DoichainUnit.DOI);
    ...
    switch (tempCustomUnit) {
      ...
      case DoichainUnit.LOCAL_CURRENCY:
        if (AmountInput.conversionCache[amount + DoichainUnit.LOCAL_CURRENCY]) {
          ...
          amount = satoshiToBTC(Number(AmountInput.conversionCache[amount + DoichainUnit.LOCAL_CURRENCY]));
  ...
  const resetCustomAmount = () => {
    setTempCustomLabel('');
    setTempCustomAmount('');
    setTempCustomUnit(wallet?.getPreferredBalanceUnit() || DoichainUnit.DOI);
    setCustomLabel('');
    setCustomAmount('');
    setCustomUnit(wallet?.getPreferredBalanceUnit() || DoichainUnit.DOI);
    // address is always defined here
